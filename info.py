...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002024179324').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002144749870')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002135593884')
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Students_Helpers')
TUTORIAL = environ.get('TUTORIAL', '')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ʜᴘ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001894706903'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Sarcastic_Group')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002131422760')).split()]
